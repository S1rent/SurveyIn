  ...
  <body>
    ...
    <main>
        ...
        <nav class="position-absolute sidebar bg-blue09173A p-4">
            ...
            <a href="creator-profile.html" class="text-decoration-none sidebar-menu mb-5" style="width: 80%;">
                <div>
            ...
            <a href="createsurvey.html" class="text-decoration-none sidebar-menu mb-4 d-flex align-items-center justify-content-start" style="width: 100%; padding: 4px 16px;">
            ...
            <a href="mysurveylist.html" class="text-decoration-none sidebar-menu mb-5 d-flex align-items-center justify-content-start" style="width: 100%; padding: 4px 16px;">
            ...
            <a href="createthread.html" class="text-decoration-none sidebar-menu mb-5 d-flex align-items-center justify-content-start" style="width: 100%; padding: 4px 16px;">
                <img src="{{ asset('images/ic-create-survey.png') }}" class="sidebar-sub-icon">
                <div style="margin-left: 16px;">
        ...
        <section class="main-content p-4">
            <a href="creator-home.html" class="text-decoration-none">
            ...
            <section class="mt-5 mb-3">
                ...
                <div class="row flex-wrap">
                    <a href="creator-surveydetail.html" class="col text-decoration-none survey-item">
                        <article >
            ...
            <section class="mt-2 mb-3">
                ...
                <a href="forum.html" class="thread-item text-decoration-none">
